...
-- Limit stuff to 80 chars

vim.wo.wrap = true
vim.wo.colorcolumn = "80"       -- Visual guide at 80 characters
vim.bo.textwidth = 80           -- Auto-wrap text at 80 characters while typing
vim.cmd("set formatoptions+=t") -- Ensure automatic wrapping while typing
